...
// Property Domains
define('PARENT_DOMAIN', 'http://localhost/');
define('RANDHOLEE_DOMAIN', 'http://randholeeresort.localhost/');
define('FIRS_DOMAIN', 'http://firs.localhost/');
define('ELLENS_DOMAIN', 'http://ellensplace.localhost/');
